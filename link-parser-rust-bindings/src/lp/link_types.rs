...
pub enum LinkTypes {
  ...
  EP, // connects "just" and "maybe" to prepositions: "MAYBE UNDER the sofa."
...
impl LinkTypes {
  pub fn from_disjunt_str(disjunct: &str) -> Self {
    let link_type_str = disjunct
      .chars()
      .filter(|c| c.is_uppercase())
      .collect::<String>();
    
    LinkTypes::from_str(&link_type_str).unwrap_or(LinkTypes::Unknown)
  }
}
